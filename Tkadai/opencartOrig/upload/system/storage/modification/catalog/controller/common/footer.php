...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['scripts'] = $this->document->getScripts('footer');
                ...
                $id = $this->config->get( 'pavothemer_footer_blockbuilder' );
                if( (int)$id ){
                    $data['blockbuilder'] = '';
                    ...
                    if ($setting_info && $setting_info['status']) {
                        $data['blockbuilder'] = $this->load->controller('extension/module/pavobuilder' , $setting_info);
                    }
                    $footer = 'footer_blockbuilder' ;
                }
